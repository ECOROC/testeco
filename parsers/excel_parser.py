...
def _extraire_poste(row: tuple, mapping: dict, lot: str,
    ...
    # Ignorer les lignes qui ne sont que des titres de section
    ...
    # Extraire le lot depuis le nom de feuille si possible
    lot_final = lot or _extraire_lot_depuis_nom(nom_feuille) or "00"

    # Extraire le nom du lot depuis le nom de feuille
